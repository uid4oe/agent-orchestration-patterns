...
| Document | Purpose |
|----------|---------|
| `PLAN.md` | Full architecture, directory structure, core design, build order |
...
**Read PLAN.md first** — it's the source of truth for all architecture decisions.
...
Check `PLAN.md` for what's done vs pending:
