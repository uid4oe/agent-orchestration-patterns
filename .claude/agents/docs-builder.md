...
- Each pattern README: what it does, when to use, tradeoffs, architecture diagram, example
- Root README: quick start (clone → env → run), pattern table, architecture diagram
